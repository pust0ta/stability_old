...
<?php if(isset($content['field_page_type'][0]['#markup']) && $content['field_page_type'][0]['#markup'] == 'Two Columns with Image'): ?>
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <?php if(isset($content['field_second_title'])):?>
        <h2><?php print strip_tags(render($content['field_second_title'])); ?></h2>
      <?php endif; ?>
...
<?php else: ?>
  <?php if(!empty($content['field_image']) && isset($content['field_image']['#items'])): ?>
    <figure class="alignleft">
      <?php print theme('image_style', array('style_name' => 'page_346x332', 'path' => $content['field_image']['#items'][0]['uri'])); ?>
    </figure>
  <?php endif; ?>
