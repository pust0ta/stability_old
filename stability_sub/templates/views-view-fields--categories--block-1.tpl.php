...
<span>
  ...
  foreach ($nids as $nid) {
    ...
    if (($stock_level == 0 or $stock_level == FALSE) and node_last_viewed($nid) == 0) {
      $asteriks = TRUE;
      break;
    };
  }
  ...
  $ready_render_term = l(t($term_name), "catalogo/" . $fields['tid']->raw, array('attributes' => array('class' => array('order-catalog-link'))));
